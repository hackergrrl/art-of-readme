...
И это нормально. Гораздо лучше иметь не очень высокую входную планку и проблему поисков,
чем иметь очень маленькое сообщество, в жизни которого могут принимать участие единицы.

Плюс ко всему, чем сложнее найти что-либо - тем проще обратиться за помощью.
...
Узел сообщество ответило на вызов понятности в
различные пути.

Некоторые опытные разработчики Node объединиться, чтобы создать [Куратор
списки] (https://github.com/sindresorhus/awesome-nodejs) модулей качества.
Разработчики использовать их много лет изучает сотни различных модулей
доля с приезжим, * сливкам *: лучшие модули в каждой категории.
Это также может принимать форму RSS-каналы и списки рассылки новых модулей соизволили
полезным доверенными членами сообщества.

Как насчет социального графа? Эта идея стимулировало создание
[Node-modules.com] (http://node-modules.com/), НПМ замена поиска,
использует ваш социальный граф Github найти модули своим друзьям, как или иметь
сделал.

Конечно, есть также НПМ встроенный [поиск] (https://npmjs.org)
Функциональность: безопасный по умолчанию, и обычный порт ввода новых разработчиков.

Независимо от того, ваш подход, независимо от того, является ли модуль спелеолог в конечном счете,
находит себя на [npmjs.org] (https://npmjs.org) или
[Github.com] (https://github.com) или где-то еще, они будут смотреть ваши
README прямо в лицо. Так как пользователи будут неизбежно в конечном итоге здесь, какие
может быть сделано, чтобы сделать это краткое впечатление максимально эффективным?
